...
import { deleteProposalAttachment } from "@/app/actions/proposals";
...
/**
 * Proposal attachments. Bytes live in object storage — this only lists metadata
 * and downloads files on demand, so the detail page stays light.
 */
export function ProposalAttachments({
  ...
  async function onFile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      fd.set("file", file);
      const res = await fetch(`/api/proposals/${proposalId}/attachments`, { method: "POST", body: fd });
