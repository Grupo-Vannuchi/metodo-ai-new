      ...
      <div className="flex flex-col gap-1.5">
        {contacts.map((card) => (
          <div
            ...
            className="hover-lift flex cursor-pointer select-none items-center gap-3 rounded-lg border border-border bg-card px-3 py-2 shadow-sm active:cursor-grabbing"
          >
